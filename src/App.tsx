...
const faqs: CardItem[] = [
  ...
  {
    title: 'Who is agent.mindvaultstudio.net for?',
        ...
        <div className="mx-auto max-w-4xl px-4 py-18 sm:px-6 sm:py-20">
          <div className="rounded-3xl border border-sand-300 bg-white p-8 shadow-sm sm:p-10">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-stone-600">
              If this is the kind of personal AI system you want, drop your email. I will send the first useful lessons and launch updates through MindVault Personal.
            </p>
